...
local NotificationHolder =
    loadstring(game:HttpGet("https://raw.githubusercontent.com/alnicke/alnicke/main/modulelua"))()
local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/alnicke/alnicke/main/clientluas"))()
local skyids = {
...
invisfling = function() -- changed to loadstring because it was so messy
    loadstring(game:HttpGet'https://raw.githubusercontent.com/alnicke/alnicke/main/NoIdentityFling')()
end
local library = loadstring(game:HttpGet("https://pastebin.com/raw/xB6h23QX"))() -- not my lib

menu = library.new('<font color="rgb(38, 55, 189)">Alnicke</font>.X', "AlnickeXConfigs\\")
local tabs = {
    menu.new_tab("http://www.roblox.com/asset/?id=9723979220"),
    menu.new_tab("http://www.roblox.com/asset/?id=8964489619"),
    menu.new_tab("http://www.roblox.com/asset/?id=8073107221"),
    menu.new_tab("http://www.roblox.com/asset/?id=11366582505"),
    menu.new_tab("http://www.roblox.com/asset/?id=8425069718")
}
...
do
    ...
    configs.element("Button","Enable Chat", nil, function()
        local newT = tick()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/alnicke/alnicke/main/chatbypass'))()
        Notification:Notify(
            {Title = "Nofitication", Description = "Loaded Chat Bypass from github in " .. tick() - newT .. "s (seconds)"},
            {OutlineColor = Color3.fromRGB(80, 80, 80), Time = 5, Type = "default"}
        )
    end)
    configs.element("Button","Disable Chat", nil, function()
    ...
    local function update_cfgs()
        all_cfgs = listfiles("AlnickeXConfigs\\")
        for _, cfg in next, all_cfgs do
            all_cfgs[_] = string.gsub(string.gsub(cfg, "AlnickeXConfigs\\", ""), ".txt", "")
...
Notification:Notify(
    {Title = "Nofitication", Description = "Alnick X hub Loaded in" .. tick() - t .. "s (seconds)"},
    {OutlineColor = Color3.fromRGB(80, 80, 80), Time = 5, Type = "default"}
)